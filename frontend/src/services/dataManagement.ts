...
export const dataManagementApi = {
  ...
  zeroStock: (payload: { productIds?: string[]; all?: boolean; confirm: string }) =>
    api.post<{ productsZeroed: number; movements: number }>('/data-management/zero-stock', payload).then((r) => r.data),
