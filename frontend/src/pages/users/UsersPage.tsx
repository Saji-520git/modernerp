...
function RoleCard({
  ...
  return (
    <button
      ...
      disabled={locked}
      className={cls(
        'w-full min-w-0 rounded-lg border-2 p-2.5 text-left transition-all',
    ...
    >
      <div className="flex items-center gap-1.5 mb-0.5">
        ...
        {locked && <Lock className="w-3 h-3 text-slate-400 ml-auto shrink-0" />}
      </div>
          ...
          <div className="flex flex-1 min-h-0 overflow-hidden">
            ...
            <div className="flex-1 min-w-0 p-6 overflow-y-auto space-y-5">
              ...
              <div>
                ...
                {role === 'SUPER_ADMIN' ? (
                  <>
                    <RoleCard role="SUPER_ADMIN" selected locked onSelect={() => {}} />
                    <p className="mt-2 text-xs text-slate-500">
                      Vendor account — the Super Admin role is locked and can't be changed here.
                    </p>
                  </>
                ) : (
