      ...
      include: {
        product: {
          select: {
            ...
            reorderQty: true,
            baseUnitId: true,
            unit:     { select: { id: true, shortCode: true, allowDecimal: true } },
            baseUnit: { select: { id: true, shortCode: true, allowDecimal: true } },
            unitConversions: {
              where: { isActive: true },
              select: {
                fromUnitId: true,
                toUnitId: true,
                conversionQty: true,
                fromUnit: { select: { id: true, shortCode: true, allowDecimal: true } },
              },
            },
