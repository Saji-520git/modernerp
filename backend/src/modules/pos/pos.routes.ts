...
router.post('/drafts',       requirePermission('pos_checkout'), ctrl.saveDraft);
router.delete('/drafts/:id', requirePermission('pos_checkout'), ctrl.deleteDraft);
...
router.post('/shifts/close',         ctrl.closeShift);
router.post('/shifts/:id/force-close', requireRole('ADMIN'), ctrl.forceCloseShift);
